...
function examinationResultsObj(people, examinations, examinationResults) {
  ...
  examinations.forEach(examination => {
    ...
    people.forEach(person => {
      if (!result[examination.id][person.studentProfileId])
        result[examination.id][person.studentProfileId] = {};
    });
  });
...
const GroupPerformanceStore = props => {
...
export default GroupPerformanceStore;
